...
zarathustra_unigrams = set(df["unigram"][:1000])
zarathustra_trigrams = list(df["trigram"])
...
microsoft_unigrams = set(df["unigram"][:1000])
microsoft_trigrams = list(df["trigram"])

intersection = microsoft_unigrams.intersection(zarathustra_unigrams)
